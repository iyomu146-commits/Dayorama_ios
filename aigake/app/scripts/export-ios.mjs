...
for(const name of ['build-walk.mjs','export-ios.mjs','verify-ios.mjs','prepare-signing.py','test_signing.py','widget-model-check.swift'])await copy(path.join(app,'scripts',name),path.join('aigake/app/scripts',name));
