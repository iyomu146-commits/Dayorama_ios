// Clothing describes climate and work, without changing the shared body rig.
const W={
...
export const REGION_LIFE={
 grove:{clothes:'カーディガン・エプロン',workers:[worker('books','本屋の店主','book','read'),worker('flowers','花の手入れ','can','water',{shirt:'#839065'}),worker('tea','喫茶の店員','cup','serve',{shirt:'#a58065'})],animals:[animal('cat','books'),animal('bird','woodland-library'),animal('butterfly','flowers','air',2)]},
...
export function regionalWorkers(id){return REGION_LIFE[id].workers.map(w=>({...w,appearance:{...W[id],...w.change,regional:true},workSeconds:w.action==='idle'?3:7}));}
