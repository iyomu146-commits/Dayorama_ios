...
import {createFloristCells,CELL} from './model.mjs';
const stage=process.argv[2]||'blockout',cells=createFloristCells({stage}),render=JSON.parse(fs.readFileSync(`evidence/${stage}-geometry.json`)),expected=new Set(),actual=new Set();let area=0;
