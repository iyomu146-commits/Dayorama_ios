...
assert json.loads(Path('strict-validation.json').read_text(encoding='utf-8-sig'))['ok']
assert json.loads(Path('reference-admission.json').read_text(encoding='utf-8-sig'))['admitted']
