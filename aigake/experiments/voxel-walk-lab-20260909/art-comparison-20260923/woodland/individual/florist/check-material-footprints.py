...
render_path=Path(f'evidence/florist-{stage}-match.png'); render=Image.open(render_path).convert('RGBA')
...
for component in spec['componentTree']:
 name=component['id'];mask_path=Path(f'evidence/florist-{stage}-footprint-{name}.png')
...
for name in ['building','roof','display-glass','greenhouse-glass','door','flowers-yellow','flowers-purple','flowers-white','display-flowers','side-flowers']:
