...
image=Path(f'evidence/home-{stage}-match.png')
...
r['evidenceMethod']='home-visible-footprint-v1; same 20 delta-E bound, occluders retained; 21 visible components, internal floor unobserved; original global palette diagnostic preserved'
