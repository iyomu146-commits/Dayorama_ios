...
image=Path(f'evidence/books-{stage}-match.png')
...
r['evidenceMethod']='books-visible-footprint-v1; same 20 delta-E bound, occluders retained; 27 specified components; actual visible count and occlusion reported per capture; original global palette diagnostic preserved'
