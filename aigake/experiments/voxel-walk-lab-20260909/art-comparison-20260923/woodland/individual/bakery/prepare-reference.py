...
source=root/'../../references/crops/bakery.png';e=root/'evidence';e.mkdir(exist_ok=True)
points=[(17,143),(17,131),(53,37),(56,22),(155,30),(164,15),(182,7),(202,13),(202,30),(213,36),(285,48),(290,61),(322,111),(326,124),(317,127),(370,143),(374,156),(365,165),(370,168),(370,263),(313,292),(284,299),(269,295),(241,289),(240,274),(229,273),(226,295),(197,301),(164,295),(142,283),(120,283),(111,293),(51,286),(45,275),(27,274),(19,265),(23,249),(32,243),(32,158)]
...
(e/'reference-mask-provenance.json').write_text(json.dumps({'source':'../../references/crops/bakery.png','sha256':hashlib.sha256(source.read_bytes()).hexdigest(),'points':points,'method':'Manual observed silhouette polygon, source RGB unchanged inside; plant occlusion and stepped roof perimeter approximate; NOT replacement artwork.','scope':'Building, attached awning, two bread stalls and two pots; street, trees, fence excluded.'},indent=2),encoding='utf-8')
